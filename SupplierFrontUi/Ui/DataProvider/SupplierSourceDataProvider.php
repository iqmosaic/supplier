...
namespace Iqmosaic\SupplierFrontUi\Ui\DataProvider;
...
use Iqmosaic\SupplierAdminUi\Ui\DataProvider\SearchResultFactory;
 ...
 * @api
 */
class SupplierSourceDataProvider extends DataProvider
{
    ...
    {
        $this->addFilterBySupplier();
        $searchCriteria = $this->getSearchCriteria();
        // var_dump($searchCriteria->getData());
        $result = $this->supplierSourceLinkRepository->getSourceList($searchCriteria);
    ...
    public function addFilterBySupplier()
    {
        $this->searchCriteriaBuilder
            ->addFilter(
                $this->filterBuilder
                    ->setField(SupplierSourceLinkInterface::SUPPLIER_ID)
                    ->setValue(3)
                    ->setConditionType('eq')
                    ->create()
            );
