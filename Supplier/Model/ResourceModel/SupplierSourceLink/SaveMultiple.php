...
use Iqmosaic\Supplier\Model\SupplierSourceLink;
/**
 * Implementation of SupplierSourceLink save multiple operation for specific db layer
...
class SaveMultiple
{
    ...
    /**
     * Multiple save SupplierSourceLinks
     *
    ...
    public function execute(array $links)
    {
        ...
        $columnsSql = $this->buildColumnsSqlPart([
            SupplierSourceLink::SOURCE_CODE,
            SupplierSourceLink::SUPPLIER_ID,
            SupplierSourceLink::STATUS,
        ]);
